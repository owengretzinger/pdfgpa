...
export default function DragAndDropFile() {
  ...
  return (
    <form
      ...
      }  relative z-50 mx-auto flex w-fit cursor-pointer flex-col items-center justify-center rounded-lg px-16 py-8 text-center shadow-lg shadow-white/20 outline-dashed outline-2 outline-white transition-transform duration-500 hover:bg-darkgrey`}
